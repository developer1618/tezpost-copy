  ...
  <div class="px-6">
    <div class="w-full py-8">
      <div class="flex items-center justify-between w-full">
        <div class="">
          <h2 class="md:text-4xl text-2xl font-bold text-gray-700 mb-2.5">Прием в Душанбе | 杜尚别接待处</h2>
          <span class="text-gray-800">Список товаров прибывших в Душанбе | 到达杜尚别的货物清单。</span>
        </div>
        <div class="flex">
