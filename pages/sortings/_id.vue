<template>
  <div class="px-6" v-if="sorting">
    ...
    <div class="w-full my-5">
      <div class="bg-white shadow sm:rounded-lg" v-if="sorting">
        <div class="px-4 py-5 border-b border-gray-200 sm:px-6">
            <h3 class="flex items-center text-lg leading-6 font-medium text-gray-900">
                ...
                <span class="text-yellow-600">{{ sorting.name }}</span>
            </h3>
        ...
        <div class="px-4 py-5 sm:p-0 mb-10">
            <dl>
                ...
                <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                    {{ parseInt(sorting.info.sortinging.weight + sorting.info.reception.weight) }} (кг)
                    </dd>
                </div>
<!--                <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">-->
<!--                    <dt class="text-sm leading-5 font-medium text-gray-500">-->
...
<!--                </div>-->
                <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                    {{ parseInt(sorting.info.sortinging.cost_china + sorting.info.reception.cost_china) }} (CNY)
                    </dd>
                </div>
                <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                    <dt class="text-sm leading-5 font-medium text-gray-500">
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                      <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full whitespace-nowrap"
                          :class="sorting.status.id == 8 ? 'bg-blue-100 text-blue-800' : 
                          (sorting.status.id == 9 ? 'bg-yellow-100 text-yellow-800' : 
                          (sorting.status.id == 11 ? 'bg-yellow-300 text-yellow-800' :'bg-green-100 text-green-800'))">
                          {{ sorting.status.name }}
                      </span>
                    </dd>
                </div>
                <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                    <dt class="text-sm leading-5 font-medium text-gray-500">
                        Дата ｜ 日期 <span class="lowercase">{{ sorting.status.name }}</span>:
                    </dt>
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                        {{ moment(String(sorting.updated_at)).format('LLL') }}
                    </dd>
                </div>
            </dl>
        </div>
            ...
            <div class="px-4 py-5 sm:p-0 mb-10">
              <dl>
                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                      ...
                      <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                      {{ sorting.info.sortinging.orders_total }} (шт)
                      </dd>
                  </div>
<!--                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">-->
<!--                      <dt class="text-sm leading-5 font-medium text-gray-500">-->
...
<!--                  </div>-->
                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                      ...
                      <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                      {{ parseInt(sorting.info.sortinging.weight) }} (кг)
                      </dd>
                  </div>
<!--                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">-->
<!--                      <dt class="text-sm leading-5 font-medium text-gray-500">-->
...
<!--                  </div>-->
                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                      ...
                      <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                      {{ sorting.info.sortinging.cost_china }} (CNY)
                      </dd>
                  </div>
              </dl>
            </div>
            ...
            <div class="px-4 py-5 sm:p-0 mb-10">
              <dl>
                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                      ...
                      <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                      {{ sorting.info.reception.orders_total }} (шт)
                      </dd>
                  </div>
<!--                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">-->
<!--                      <dt class="text-sm leading-5 font-medium text-gray-500">-->
...
<!--                  </div>-->
                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                      ...
                      <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                      {{ parseInt(sorting.info.reception.weight) }} (кг)
                      </dd>
                  </div>
<!--                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">-->
<!--                      <dt class="text-sm leading-5 font-medium text-gray-500">-->
...
<!--                  </div>-->
                  <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                      ...
                      <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                      {{ sorting.info.reception.cost_china }} (CNY)
                      </dd>
                  </div>
              </dl>
            </div>
...
export default {
  ...
  methods: {
    init(){
      this.$axios.get(`/dashboard/sortings/${this.$route.params.id}`).then(res=> {
