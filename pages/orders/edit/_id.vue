  ...
  <div class="px-6">
    <div class="w-full py-8">
      <div class="flex items-center justify-between w-full">
        <div class="">
          <h2 class="md:text-4xl text-2xl font-bold text-gray-700">
            Редактировить
          </h2>
          ...
          <form class="space-y-6" @submit.prevent="save">
            <div class="flex flex-wrap w-full">
              ...
              <div class="w-full px-3">
                ...
                <span class="text-sm text-gray-500"
                  ...
                  пожалуйста поставьте свое описание
                </span>
                <div class="mt-1">
            ...
            <div>
              <d-button
                ...
                classList="rounded bg-bo-primary text-center text-white py-3 px-7 mt-3 lg:ml-3 w-full md:w-max hover:bg-bo-primary"
              />
            </div>
          </form>
        </div>
...
export default {
  ...
  methods: {
    init() {
      this.$axios
        .get(`/dashboard/orders/${this.$route.params.id}`)
        .then((res) => {
          this.order = res.data.order;
        });

      this.$axios
        .get("/dashboard/get-data?directions=1&shippings=1&users=1", {
          params: {
    ...
    save() {
      ...
      this.$axios
        .put(`/dashboard/orders/${this.order.id}`, this.order)
        .then((res) => {
          this.$swal({
            icon: "success",
            title: "Успешно",
