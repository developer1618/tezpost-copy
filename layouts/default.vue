  ...
  <div class="">
    <div class="w-full flex h-full">
      ...
      <aside
        :class="
          `${
            showMenu ? 'xl:w-1/5 lg:w-1/3 md:w-1/2 w-3/4' : 'w-0'
          } inline-block transition-all delay-200`
        "
      >
        <div
          :class="
            `${
              showMenu ? 'xl:w-1/5 lg:w-1/3 md:w-1/2 w-3/4' : 'w-0'
            } z-50 fixed transition-all delay-200 top-0 left-0 bg-gray-800 overflow-y-auto bottom-0`
          "
        >
          <div class="text-center py-6 flex justify-between px-4">
            <nuxt-link to="/">
            ...
            <button
              ...
              class="text-white cursor-pointer lg:hidden focus:outline-none"
            >
              <svg
          ...
          <div class="">
            <div class="mt-2 mx-3">
              <ul>
                ...
                <li
                  ...
                  v-if="
                    hasPermission('task-show') ||
                      ...
                      hasPermission('box-show') ||
                      hasPermission('send-show') ||
                      hasPermission('reception-dushanbe-show')
                  "
                >
                  <a
                    @click="settingShow1 = !settingShow1"
                    class="text-gray-300 hover:bg-gray-700 hover:text-white group flex justify-between cursor-pointer items-center px-2 py-2 text-base font-medium rounded-md"
                  >
                    <div class="flex">
                      <svg
                        class="text-gray-400 group-hover:text-gray-300 mr-4 w-6 h-6"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <ul :class="`ml-6 ${settingShow1 ? 'block' : 'hidden'}`">
                    <li class="mb-1" v-if="hasPermission('order-show')">
                      <nuxt-link
                        to="/orders"
                        :class="
                          $nuxt.$route.path.startsWith('/orders')
                            ? 'bg-gray-900'
                            : ''
                        "
                    ...
                    <li class="mb-1" v-if="hasPermission('box-show')">
                      <nuxt-link
                        to="/boxes"
                        :class="
                          $nuxt.$route.path.startsWith('/boxes')
                            ? 'bg-gray-900'
                            : ''
                        "
                        exact-active-class="bg-gray-900"
                    ...
                    <li class="mb-1" v-if="hasPermission('send-show')">
                      <nuxt-link
                        to="/sends"
                        :class="
                          $nuxt.$route.path.startsWith('/sends')
                            ? 'bg-gray-900'
                            : ''
                        "
                        exact-active-class="bg-gray-900"
                    ...
                    <li
                      class="mb-1"
                      v-if="hasPermission('reception-dushanbe-show')"
                    >
                      <nuxt-link
                        to="/reception"
                        :class="
                          $nuxt.$route.path.startsWith('/reception')
                            ? 'bg-gray-900'
                            : ''
                        "
                        exact-active-class="bg-gray-900"
                ...
                >
                  <a
                    @click="settingShow2 = !settingShow2"
                    class="text-gray-300 hover:bg-gray-700 hover:text-white group flex justify-between cursor-pointer items-center px-2 py-2 text-base font-medium rounded-md"
                  >
                    <div class="flex">
                      <svg
                  ...
                  <ul :class="`ml-6 ${settingShow2 ? 'block' : 'hidden'}`">
                    <li class="mb-1" v-if="hasPermission('order-show')">
                      <nuxt-link
                        to="/returns/orders"
                        :class="
                          `${
                            $nuxt.$route.path.startsWith('/returns/orders')
                              ? 'bg-gray-900'
                              : ''
                    ...
                    <li class="mb-1" v-if="hasPermission('box-show')">
                      <nuxt-link
                        ...
                        :class="
                          `${
                            $nuxt.$route.path.startsWith('/returns/boxes')
                              ? 'bg-gray-900'
                              : ''
                          } text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md`
                        "
                ...
                >
                  <a
                    @click="settingShow3 = !settingShow3"
                    class="text-gray-300 hover:bg-gray-700 hover:text-white group flex justify-between cursor-pointer items-center px-2 py-2 text-base font-medium rounded-md"
                  >
                    <div class="flex">
                      <svg
                ...
                <li class="mb-1" v-if="hasPermission('payment-show')">
                  <nuxt-link
                    ...
                    :class="
                      `${
                        $nuxt.$route.path == '/payments' ? 'bg-gray-900' : ''
                      } text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md`
                    "
                  >
                    <svg
                      class="text-gray-400 group-hover:text-gay-300 mr-4 w-6 h-6"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li
                  ...
                  v-if="
                    hasPermission('user-show') ||
                      hasPermission('employeer-show')
                  "
                >
                  <a
                    @click="settingShow4 = !settingShow4"
                    class="text-gray-300 hover:bg-gray-700 hover:text-white group flex justify-between cursor-pointer items-center px-2 py-2 text-base font-medium rounded-md"
                  >
                    <div class="flex">
                      <svg
                  ...
                  <ul :class="`ml-6 ${settingShow4 ? 'block' : 'hidden'}`">
                    <li class="mb-1" v-if="hasPermission('user-show')">
                      <nuxt-link
                        ...
                        :class="
                          `${
                            $nuxt.$route.path.startsWith('/users')
                              ? 'bg-gray-900'
                              : ''
                          } text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md`
                        "
                    ...
                    <li class="mb-1" v-if="hasPermission('employeer-show')">
                      <nuxt-link
                        ...
                        :class="
                          `${
                            $nuxt.$route.path.startsWith('/employees')
                              ? 'bg-gray-900'
                              : ''
                          } text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md`
                        "
                ...
                <li class="mb-1" v-if="hasPermission('direction-show')">
                  <nuxt-link
                    ...
                    :class="
                      `${
                        $nuxt.$route.path == '/directions' ? 'bg-gray-900' : ''
                      } text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md`
                    "
                  >
                    <svg
                ...
                <li class="mb-1" v-if="hasPermission('shipping-show')">
                  <nuxt-link
                    ...
                    :class="
                      `${
                        $nuxt.$route.path == '/shippings' ? 'bg-gray-900' : ''
                      } text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md`
                    "
                  >
                    <svg
                ...
                <li class="mb-1" v-if="hasPermission('admin-show')">
                  <nuxt-link
                    ...
                    :class="
                      `${
                        $nuxt.$route.path == '/roles' ? 'bg-gray-900' : ''
                      } text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md`
                    "
                  >
                    <svg
      ...
      <main
        :class="
          `${
            showMenu ? 'xl:w-4/5 lg:w-2/3' : 'w-full'
          } w-full transition-all delay-200 inline-block pb-16 bg-gray-100`
        "
      >
        <!-- start navbar -->
              ...
              <li class="flex items-center justify-center h-16 w-12 relative">
                ...
                <div
                  :class="
                    `${
                      userShow ? '' : 'hidden'
                    } dropdown absolute top-0 right-0 mt-16 open border-t-2`
                  "
                >
...
export default {
  ...
  methods: {
    ...
    hasPermission(perm) {
      return this.$store.$auth.$state.user.allPermissions.filter(
        (o) => o.name === perm
      ).length > 0 ||
        this.$store.$auth.$state.user.allPermissions.filter(
          (o) => o.name === "admin-show"
        ).length > 0
        ? true
        : false;
